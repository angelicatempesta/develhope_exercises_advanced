...
public class Exercises {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1: ");
        Person p = new Person("Mauro", 20, "via Roma 13");
        System.out.println(p);// Your code here
    }
    ...
    private static void exercise2() {
        System.out.println("\nExercise 1: ");
        Person p1 = new Person("Giuseppe", 12, "via Palemmo");// Your code here
        Person p2 = new Person("Filippo", 78, "viale degli Oceani");
