...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        ourNumbers.stream().filter(number -> number % 2 == 0).forEach(System.out::println);
        // Your code here
    }
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2: ");
        List<Integer> ourNumbers = IntStream.range(1, 10).boxed().toList();
        Set<Integer> odd = ourNumbers.stream().filter(number -> number % 2 != 0).collect(Collectors.toSet());
    ...
    private static void exercise3() {
        ...
        upperCaseStrings.stream().forEach(System.out::println);// Your code here
    }
    ...
    private static void exercise4() {
        System.out.println("\nExercise 4");
        List<Integer> ourNumbers = IntStream.range(1, 10).boxed().toList();
        Set<Integer> evenNumbersByTwo = ourNumbers.stream().filter(number -> number % 2 == 0).map(number -> number * 2).collect(Collectors.toSet());
        System.out.println(evenNumbersByTwo);//Your code here
    }
}
