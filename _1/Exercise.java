...
public class Exercise {
    ...
    private static void exercise1() {
        ...
        if (ourSet.containsAll(Set.of(1, 5, 2))) {   // <---- Ho dovuto rimuovere gli altri numeri 1 presenti nel se.of altrimenti ci dava errore
        ...
        ourSet.remove(1);// Remove the element '1'
        System.out.println(ourSet);// Your code
    ...
    private static void exercise2() {
        ...
        //2a. What will this output? Di sicuro sappiamo che non aggiungerà gli elementi presenti in fruitsSet, dato che sono
        // dei perfetti duplicati. Per il resto non possiamo sapere esattamente l'ordine in cui ci stamperà gli elementi presenti
        //  nel set, poichè sappiamo che sicuramente non ce li restituirà nè in ordine alfabetico nè in ordine di inserimento,
        //   perciò il ritorno sarà non proprio casuale, ma in base all'efficenza con cui se li memorizza in memoria.
        ...
        //2b. What will this output? Di sicuro usando il metodo addAll in fruitsSet e aggiungendoci fruitsList, verranno aggiunti
        // solamente gli elementi che non sono dei duplicati, quindi solamente grapes e pear.
        System.out.println(fruitsSet);
    }
